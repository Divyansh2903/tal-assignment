      ...
      >
        <View style={styles.bannerContainer}>
          ...
          <View style={styles.bannerContent}>
            ...
            <Image
              source={require("../../../../assets/happy_girl.png")}
...
const styles = StyleSheet.create({
  ...
  bannerButtonWrapper: {
    zIndex: 2,
    backgroundColor: "rgba(251, 236, 211, 0.37)",
    borderRadius: 18,
    paddingBottom: 4,
  },
  bannerButton: {
  ...
  iconButton: {
    backgroundColor: "rgba(230, 242, 240, 1)",
    paddingVertical: 8,
